<template>
  ...
  <div>
    ...
    <div class="columns" style=" padding-top: 4rem; padding-left: 45vh; padding-right: 45vh">
    ...
    <div class="columns" style=" padding-top: 3rem; padding-left: 45vh; padding-right: 45vh">
